...
public class ErshouActivity extends Activity /**implements OnClickListener*/{
...
protected void onCreate(Bundle savedInstanceState) {
	...
	Intent intent = new Intent(ErshouActivity.this,TopicActivity.class);
	startActivity(intent);
//	setContentView(R.layout.circleershouactivity);
...
////		 点击进入发表
//		this.startActivity(new Intent(ErshouActivity.this,
